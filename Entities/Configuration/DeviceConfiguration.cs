        ...
        public void Configure(EntityTypeBuilder<Device> builder)
        {
            builder.HasData(
                new Device
                {
                    ...
                    PurchaseDate = new DateTime(2020, 8, 21),
                    UpdateCost = (decimal) 112.56,
                    LastUpdateDate = new DateTime(2020, 11, 1),
                    Warranty = "3y",
                    WarrantyExpires = new DateTime(2023, 8, 21),
                ...
                new Device
                {
                    ...
                    PurchaseCost = 545,
                    PurchaseDate = new DateTime(2020, 12, 1),
                    Warranty = "1y",
                    WarrantyExpires = new DateTime(2021, 12, 1),
                ...
                new Device
                {
                    ...
                    PurchaseDate = new DateTime(2020, 3, 14),
                    Warranty = "3y",
                    WarrantyExpires = new DateTime(2023, 3, 14),

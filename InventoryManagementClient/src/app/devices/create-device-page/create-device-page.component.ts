...
export class CreateDevicePageComponent implements OnInit {
  ...
  submit() {
    ...
    const deviceForCreationModel: DeviceForCreationModel = {
    ...
    this.deviceService.create(deviceForCreationModel).subscribe(() => {
